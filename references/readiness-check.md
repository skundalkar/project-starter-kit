# Project Starter Kit: Readiness Check

Use this checklist before generating formal project artifacts.

The goal is not perfection. The goal is enough clarity that the first product brief will be grounded instead of guessed.
...
- Product category
- Primary user
- Anchor situation or constructed first-use scenario
- Current state before the product helps
- Desired state after the product helps
- Core product promise
- Chosen operating model, especially if the user started with a generic noun like dashboard, app, tracker, monitor, assistant, or report
- Primary user inference or decision the product must support
...
- First user journey or screen sequence
- Signal-to-evidence path for analytics, monitoring, AI, workflow, or decision-support products
...
- Operating model
- Primary inference
- Signal-to-evidence path, if applicable
- Key outputs
- Exclusions
- Feasibility risks
